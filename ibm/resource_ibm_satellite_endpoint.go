	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"connection_type": &schema.Schema{
				Type:         schema.TypeString,
				Required:     true,
				ValidateFunc: InvokeValidator("ibm_satellite_endpoint", "connection_type"),
			...
			"client_protocol": &schema.Schema{
				Type:         schema.TypeString,
				Required:     true,
				ValidateFunc: InvokeValidator("ibm_satellite_endpoint", "client_protocol"),
				Description:  "The protocol in the client application side.",
			},
			"client_mutual_auth": &schema.Schema{
			...
			"server_protocol": &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				ValidateFunc: InvokeValidator("ibm_satellite_endpoint", "server_protocol"),
			...
			"timeout": &schema.Schema{
				Type:         schema.TypeInt,
				Optional:     true,
				ValidateFunc: InvokeValidator("ibm_satellite_endpoint", "timeout"),
...
func resourceIbmSatelliteEndpointValidator() *ResourceValidator {
	...
	resourceValidator := ResourceValidator{ResourceName: "ibm_satellite_endpoint", Schema: validateSchema}
...
func resourceIbmSatelliteEndpointEndpointPerformanceToMap(endpointPerformance satellitelinkv1.EndpointPerformance) map[string]interface{} {
	...
	endpointPerformanceMap["connection"] = intValue(endpointPerformance.Connection)
	endpointPerformanceMap["rx_bandwidth"] = intValue(endpointPerformance.RxBandwidth)
	endpointPerformanceMap["tx_bandwidth"] = intValue(endpointPerformance.TxBandwidth)
	endpointPerformanceMap["bandwidth"] = intValue(endpointPerformance.Bandwidth)
...
func resourceIbmSatelliteEndpointEndpointPerformanceConnectorsItemToMap(endpointPerformanceConnectorsItem satellitelinkv1.EndpointPerformanceConnectorsItem) map[string]interface{} {
	...
	endpointPerformanceConnectorsItemMap["connections"] = intValue(endpointPerformanceConnectorsItem.Connections)
	endpointPerformanceConnectorsItemMap["rxBW"] = intValue(endpointPerformanceConnectorsItem.RxBW)
	endpointPerformanceConnectorsItemMap["txBW"] = intValue(endpointPerformanceConnectorsItem.TxBW)
