...
func TestAccIBMAppIDCloudDirectoryTemplateDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: setupAppIDCloudDirectoryTemplateDataSourceConfig(appIDTenantID, subject, htmlBody, textBody),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.ibm_appid_cloud_directory_template.test_tpl", "tenant_id", appIDTenantID),
