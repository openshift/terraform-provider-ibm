...
func TestAccIBMSccSiOccurrenceDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMSccSiOccurrenceDataSourceConfigBasic(scc_si_account, apiOccurrenceProviderID, apiOccurrencenoteID, apiOccurrenceKind, apiOccurrenceID),
...
func TestAccIBMSccSiOccurrenceDataSourceAllArgs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMSccSiOccurrenceDataSourceConfig(scc_si_account, apiOccurrenceProviderID, apiOccurrencenoteID, apiOccurrenceKind, apiOccurrenceID, apiOccurrenceResourceURL, apiOccurrenceRemediation, apiOccurrenceReplaceIfExists),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_scc_si_occurrence.scc_si_occurrence", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_scc_si_occurrence.scc_si_occurrence", "provider_id"),
					resource.TestCheckResourceAttrSet("data.ibm_scc_si_occurrence.scc_si_occurrence", "occurrence_id"),
