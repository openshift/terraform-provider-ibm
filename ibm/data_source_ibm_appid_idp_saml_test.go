...
func TestAccIBMAppIDIDPSamlDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMAppIDIDPSAMLDataSourceConfig(appIDTenantID, dispName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.ibm_appid_idp_saml.test_saml", "tenant_id", appIDTenantID),
