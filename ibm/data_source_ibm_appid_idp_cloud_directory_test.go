...
func TestAccIBMAppIDIDPCloudDirectoryDataSource_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: setupIBMAppIDCloudDirectoryIDPConfig(appIDTenantID),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.ibm_appid_idp_cloud_directory.idp", "tenant_id", appIDTenantID),
