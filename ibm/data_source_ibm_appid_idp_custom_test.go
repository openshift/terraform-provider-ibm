...
func TestAccIBMAppIDIDPCustomDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: setupAppIDCustomIDPDataSourceConfig(appIDTenantID, publicKey),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.ibm_appid_idp_custom.idp", "tenant_id", appIDTenantID),
