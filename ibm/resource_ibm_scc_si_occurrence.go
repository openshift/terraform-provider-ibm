	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"kind": &schema.Schema{
				Type:         schema.TypeString,
				Required:     true,
				ValidateFunc: InvokeValidator("ibm_scc_si_occurrence", "kind"),
			...
			"replace_if_exists": &schema.Schema{
...
func resourceIBMSccSiOccurrenceValidator() *ResourceValidator {
	...
	resourceValidator := ResourceValidator{ResourceName: "ibm_scc_si_occurrence", Schema: validateSchema}
...
func resourceIBMSccSiOccurrenceSocketAddressToMap(socketAddress findingsv1.SocketAddress) map[string]interface{} {
	...
	if socketAddress.Port != nil {
		socketAddressMap["port"] = intValue(socketAddress.Port)
	}
...
func resourceIBMSccSiOccurrenceDataTransferredToMap(dataTransferred findingsv1.DataTransferred) map[string]interface{} {
	...
	if dataTransferred.ClientBytes != nil {
		dataTransferredMap["client_bytes"] = intValue(dataTransferred.ClientBytes)
	}
	if dataTransferred.ServerBytes != nil {
		dataTransferredMap["server_bytes"] = intValue(dataTransferred.ServerBytes)
	}
	if dataTransferred.ClientPackets != nil {
		dataTransferredMap["client_packets"] = intValue(dataTransferred.ClientPackets)
	}
	if dataTransferred.ServerPackets != nil {
		dataTransferredMap["server_packets"] = intValue(dataTransferred.ServerPackets)
	}
